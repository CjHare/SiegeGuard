...
import {FifthDimensionSecurityDomainRoutes} from './route/fifth-dimension-security-domain-routes'
import {log} from './container'

// The log reference triggers init of the container
log.verbose('Container initialization')

const app = new App([new FifthDimensionSecurityDomainRoutes()], getPort())
